...
if(penguin_get_options_key('custom-enable-color') == "on"){
	...
	$theme_customize_list['mobile_menu_background_color_hover']			= $current_colors['custom-mobile-menu-background-hover-color'];	
	...
	$theme_customize_list['style_2_mobile_menu_background_color']				= $current_colors['custom-mobile-menu-background-color'];	
	$theme_customize_list['style_2_mobile_menu_background_color_hover']			= $current_colors['custom-mobile-menu-background-hover-color'];	
	$theme_customize_list['style_2_mobile_menu_color']							= $current_colors['custom-mobile-menu-font-color'];	
	$theme_customize_list['style_2_mobile_menu_color_hover']					= $current_colors['custom-mobile-menu-hover-font-color'];
