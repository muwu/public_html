...
$page_content[] = array(
		...
		'elements'	=> array(
			...
			'padding_custom'	=> array(
				'title' => __('Header Area Padding Setting','alterna'),
				'type' 	=> 'moreline',
				'moreline'	=> array(
			...
			'theme_color'		=> array(
				...
				'theme_mobile_menu_color'		=> array(
						...
						'moreline'	=> array(
								...
								'mobile_menu_bg_hover_color' => array(
									'name'	=> __('Background Hover Color','alterna'),
									'type' 	=> 'color',
									'property' => 'custom-mobile-menu-background-hover-color',
									'desc'	=> __('Header mobile menu background hover color','alterna')
									),
				...
				'portfolio_single_page' => array(
							...
							'moreline'	=> array(
											...
											'post_style'		=> array(
													...
													'default'	=> 0,
													'options'	=> array(0 => __('Style #1','alterna'), 1 => __('Style #2','alterna'), 2 => __('Style #3','alterna'))
											),
											'enable_breadchrumb' => array(
													'name'	=> __('Category for Single Post Breadchrumb','alterna'),
													'type'	=>	'pc',
...
'footer-copyright-message'		=> 'Copyright &copy; 2014 <a href="http://themeforest.net/user/ThemeFocus">ThemeFocus</a>. All rights reserved.',
...
'custom-mobile-menu-background-hover-color'	=>	'7ab80e',
'custom-mobile-menu-font-color'				=>	'ffffff',
									...
									'element-template' => array(	
											...
											'fields'	=>	array(
														...
														array(	'name' 	=> 'portfolio-post-style',
																...
																'type'	=>	'select',
																'options' => array(__('Use Global','alterna'),__('Style #1','alterna'),__('Style #2','alterna'),__('Style #3','alterna')),
...
function on_envato_init(){
	...
	$upgrader = new Envato_WordPress_Theme_Upgrader(penguin_get_options_key('theme-name') , penguin_get_options_key('theme-api') );
	/*
