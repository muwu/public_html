...
function alterna_init_styles_scripts() {
	...
	if(penguin_get_options_key('bootstrap-fontawesome-cdn') == "on"){
		wp_enqueue_style( 'bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css' , array() , $ver );
		wp_enqueue_style( 'fontawesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css' , array() , $ver );
	}else{
	...
	if(penguin_get_options_key('bootstrap-fontawesome-cdn') == "on"){
		wp_enqueue_script( 'bootstrap' , '//maxcdn.bootstrapcdn.com/bootstrap/3.3.1/js/bootstrap.min.js' , array('jquery') , $ver , true);
	}else{
	...
	if (class_exists( 'woocommerce' )) { 
		wp_enqueue_script( 'woocommerce_js' , $dir . '/woocommerce/assets/js/woocommerce.js' , array('jquery') , $ver , true);
		wc_enqueue_js( "$('body').alternawcInit();" );
	}
}
...
add_filter( 'wp_title', 'alterna_wp_title', 10, 2 );
